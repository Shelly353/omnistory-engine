...
11. 如果《本章任务梗概》中包含“SOP写作硬边界”“已确认的本事件故事梗概”或“最终SOP大纲”，这些内容是最高优先级。不得新增会改变因果链的事件、隐藏真相、反派计划、人物关系、能力、道具、死因、时间顺序或世界规则；不得提前解决下一事件；不得把下一事件核心内容写进当前事件。
12. 如果需要补充《本章任务梗概》没有写明的环境、动作、心理、对白，只能补不改变剧情事实的表现层细节。任何创造性润色都不能覆盖已确认梗概和最终大纲。
13. 如果《本章场景卡》《角色声音》《对白专项》《动作/场面导演》与《已确认的本事件故事梗概》或《最终SOP大纲》冲突，必须服从事件梗概和最终大纲。
14. 如果《好莱坞大片蓝图/阻力/长篇状态》中包含篇幅规划、节拍表、连续性账本、章节看板、强制验收或人物/反派弧光表，正文必须服务这些全书生产约束。
15. 如果《好莱坞大片蓝图/阻力/长篇状态》中包含角色声音、对白专项、动作/场面导演、情感/关系线、主题与母题追踪，正文必须执行：人物说话要可区分，场面要有空间和代价，关系变化要由选择触发，主题要通过意象和行动呈现。
16. 涉及历史、法律、医疗、行业流程、现实资料时，必须优先依据《统一规则/专家资料与正文监督标准》或本地资料片段；资料不足时写得谨慎，不要伪造来源或确定事实。
17. 如果上下文包含《上帝视角信息权限》，未揭露/部分揭露的秘密只能用于后台因果校验，正文中的角色和观众只能知道观众视角；已揭露后才可把上帝视角作为公开事实。
18. 用词、器物、货币、称谓、计量单位和时代语感必须连续一致。同一物件不能前后变形，例如“碎银三两”不能无因写成“铜钱洒了一地”；如需兑换、掉包、误认或伪装，必须在正文中交代原因。
19. 语言风格要符合当前作品调性，文字要有画面感和张力。
20. 直接输出正文内容，绝不要输出任何解释性废话（如“好的，我这就开始写”）。`;
