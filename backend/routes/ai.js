...
14. 如果上下文包含《上帝视角信息权限》，未揭露/部分揭露的秘密只能用于后台因果校验，正文中的角色和观众只能知道观众视角；已揭露后才可把上帝视角作为公开事实。
15. 用词、器物、货币、称谓、计量单位和时代语感必须连续一致。同一物件不能前后变形，例如“碎银三两”不能无因写成“铜钱洒了一地”；如需兑换、掉包、误认或伪装，必须在正文中交代原因。
16. 语言风格要符合当前作品调性，文字要有画面感和张力。
17. 直接输出正文内容，绝不要输出任何解释性废话（如“好的，我这就开始写”）。`;
