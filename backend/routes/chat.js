...
7. 沙盒主流程必须按：救猫咪类型 -> 开始事件 -> 结束事件 -> 主角 -> 最终反派 -> 主角弧线 -> 反派弧线 -> 好莱坞六节点 -> 桥接事件 -> 时间线/人物卡/规则/观众视角/上帝视角 -> 沙盒验收。沙盒只做故事骨架，不做章节细化和正文。
...
10. 例如：如果用户说“两个家族反目”，你要问“导火索是什么？是利益分配不均，还是年轻一代的情感纠葛？”让用户来选择或补充。`;
